...
func (f *MockConnectionFactory) Create(context.Context) (Session, error) {
...
func (c *mockConnection) Sender(_ context.Context, address string, _ *amqp.SenderOptions) (Sender, error) {
	return &mockSender{address: address, connection: c, done: make(chan struct{})}, nil
}

func (c *mockConnection) Receiver(_ context.Context, address string, opts *amqp.ReceiverOptions) (Receiver, error) {
	if opts == nil {
